...
export default function Environment()
{
    return(
        <>
            <MountainGroup position={ [ - 114, - 30, 319 ] } scale={ 50 } rotation-y={ Math.PI * 0.1 } />
            <MountainGroup position={ [ 400, - 30, 400 ] } scale={ 50 } rotation-y={ Math.PI * 1 } />
            <MountainGroup position={ [ - 70, - 30, - 470 ] } scale={ 40 } rotation-y={ Math.PI * 1.05 } />
            
            <MountainGroup2 position={ [ 465, - 30, - 165 ] } scale={ 40 } rotation-y={ Math.PI * 1.5 } />
